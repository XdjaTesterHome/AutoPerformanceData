...
urlpatterns = [
    ...
    url(r'^getFpsData/(?P<package_name>\S+)/(?P<version_name>\S+)/', views.get_fps_data, name='get_fps_data'),
    url(r'^getMem/', views.get_memory, name='memory_info'),
    url(r'^getMemData/(?P<package_name>\S+)/(?P<version_name>\S+)/', views.get_memory_data, name='get_mem_data'),
    url(r'^getCpu/', views.get_cpu, name='cpu_info'),
    url(r'^getCpuData/(?P<package_name>\S+)/(?P<version_name>\S+)/', views.get_cpu_data, name='get_cpu_data'),
    url(r'^getFlow/', views.get_flow, name='flow_info'),
    url(r'^getFlowData/(?P<package_name>\S+)/(?P<version_name>\S+)/', views.get_flow_data, name='get_flow_data'),
